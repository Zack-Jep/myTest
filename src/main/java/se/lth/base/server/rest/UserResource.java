...
public class UserResource {
  ...
  public Response login(
      Credentials credentials, @QueryParam("remember") @DefaultValue("false") boolean rememberMe)
    ...
    return Response.noContent()
        .cookie(newCookie(newSession.getSessionId().toString(), maxAge, null))
        .build();
  }
  ...
  // Check to see if email or user name is available.
  @Path("register")
  @POST
  @Consumes(MediaType.APPLICATION_JSON + ";charset=utf-8")
  @PermitAll
