...
public class BaseServer {
  ...
  public static void main(String[] args) {
    ...
    server.setRequestLog(
        (request, response) ->
            StdErrLog.getLogger(BaseServer.class)
                .info(
                    request.getMethod()
                        + " "
    ...
    HandlerList handlers =
        new HandlerList(indexHandler(), staticContentHandler(), jerseyHandler(jerseyConfig()));
    ...
    return new AbstractHandler() {
      ...
      public void handle(
        ...
        if (target.equals("/")) {
          ...
          copyStream(
              BaseServer.class.getResourceAsStream("/webassets/index.html"),
  ...
  static Handler jerseyHandler(ResourceConfig resourceConfig) {
    ...
    ServletContextHandler jerseyContext =
